...
if __name__ == '__main__':
    ...
    import roslib; roslib.load_manifest('rgbd_rosbag_tools')
    import rospy
    import rosbag
    ...
    for topic, msg, t in inbag.read_messages():
        ...
        if topic == "/camera/depth_registered/camera_info":
        ...
        if topic == "/camera/rgb/image_color" and rgb_camera_info:
            rgb_image_color = msg
            continue
        if topic == "/camera/depth_registered/image" and depth_camera_info and rgb_image_color and rgb_camera_info:
            depth_image = msg
            # now process frame
            ...
            if frame % float(args.nth) == 0:
                if args.skip > 0:
                    ...
                    outbag.write("/camera/depth_registered/points", rgb_points, t)
            # consume the images
            depth_image = None
            rgb_image_color = None
            continue
        if topic not in ["/camera/depth_registered/camera_info","/camera/rgb/camera_info",
